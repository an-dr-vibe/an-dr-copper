...
2. Optional command parity:
   - `copper ui open --extension <extension-id>`
3. UI behavior:
...
- Implemented command: `copper ui open --extension <id>`.
...
- Legacy `data.json` remains a compatibility fallback for existing installs.

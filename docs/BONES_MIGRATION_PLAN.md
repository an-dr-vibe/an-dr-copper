...
| 2026-07-27 | Reconciled the final CLI and documentation contracts after whole-branch review: local `trigger` is explicitly mutating Component execution, daemon trigger reports dispatch, and removed dual-runtime/subprocess paths no longer appear in current architecture guidance. |

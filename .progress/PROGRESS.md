...
- [ ] **Bones-backed control plane and scheduling** (verified) — ~300 lines: route Copper trigger/background workflows through Bones messages while preserving authenticated CLI/HTTP behavior.
...
_Last updated: 2026-07-26T23:19:34.2083770Z_